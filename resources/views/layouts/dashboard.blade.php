...
<head>
    ...
    <title>US HQ Wireless - Admin Dashboard</title>
    <!-- Favicon icon -->
    ...
    <div id="main-wrapper">
        ...
        **********************************
            ...
            <div class="deznav-scroll">
				...
				<div class="copyright">
					<p><strong>Gymove Admin Dashboard</strong> © 2023 All Rights Reserved</p>
					<p>Made with <span class="heart"></span> by <br> <a href="https://www.n2sys.com/" target="_blank">n2sys Technology</a></p>
				</div>
        ...
        ***********************************-->
        <div class="footer" style="margin-top: 150px">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="https://www.n2sys.com/" target="_blank">n2sys Technology</a> 2023</p>
            </div>
        </div>
        <!--**********************************
            Footer end
